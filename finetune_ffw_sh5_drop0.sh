...
OUTPUT_DIR="${OUTPUT_DIR:-$REPO_DIR/ffw_sh5_n17-checkpoint1_drop0}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-ffw_sh5_n17_psc_left_drop0}"
WANDB_PROJECT="${WANDB_PROJECT:-finetune-gr00t-n1d7-ffw-sh5-drop0}"

# Same as finetune_ffw_sh5.sh, but state_dropout_prob=0.0 (N1.6-style).
...
if [[ "${PREFLIGHT_ONLY:-0}" == "1" ]]; then
    echo "FFW SH5 N1.7 preflight passed (state_dropout_prob=0.0)."
