...
# Add doyoung
class FfwSh5Rev127DofDataConfig(BaseDataConfig):
    """FFW SH5 rev1: head cam + right arm (7) + right hand (20); matches meta/modality.json."""
...
DATA_CONFIG_MAP = {
    ...
    "ffw_sh5_27dof": FfwSh5Rev127DofDataConfig(),   # add doyoung
