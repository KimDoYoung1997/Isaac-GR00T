...
OUTPUT_DIR="${OUTPUT_DIR:-$REPO_DIR/ffw_sh5_n17-checkpoint1}"

# Keep the same training schedule as the previous N1.6 FFW SH5 run.
...
if [[ "${PREFLIGHT_ONLY:-0}" == "1" ]]; then
    echo "FFW SH5 N1.7 preflight passed."
