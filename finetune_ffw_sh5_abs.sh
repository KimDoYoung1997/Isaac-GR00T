...
MODALITY_CONFIG_PATH="${MODALITY_CONFIG_PATH:-$REPO_DIR/examples/FFW_SH5/ffw_sh5_config_abs.py}"
OUTPUT_DIR="${OUTPUT_DIR:-$REPO_DIR/ffw_sh5_n17-checkpoint2_abs}"
EXPERIMENT_NAME="${EXPERIMENT_NAME:-ffw_sh5_n17_psc_left_abs}"
WANDB_PROJECT="${WANDB_PROJECT:-finetune-gr00t-n1d7-ffw-sh5-abs}"

# Absolute-action modality: left_arm + left_hand both use ABSOLUTE targets.
...
if [[ "${PREFLIGHT_ONLY:-0}" == "1" ]]; then
    echo "FFW SH5 N1.7 absolute-action preflight passed."
